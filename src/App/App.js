...
import EditMilestone from '../components/pages/EditMilestone/EditMilestone';
import EditChild from '../components/pages/EditChild/EditChild';
import Home from '../components/pages/Home/Home';
import NewMilestone from '../components/pages/NewMilestone/NewMilestone';
import NewChild from '../components/pages/NewChild/NewChild';
import SingleChildView from '../components/pages/SingleChildView/SingleChildView';
